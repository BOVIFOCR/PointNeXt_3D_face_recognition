...
class WEBFACE_3D(Dataset):
    ...
    def __init__(self,
        ...
        if not os.path.isfile(path_paths_file):
            subjects_with_pc_paths, unique_subjects_names, samples_per_subject = TreeWEBFACE_3DReconstructedMICA().load_filter_organize_pointclouds_paths(self.DATA_PATH, dir_level, file_ext, min_samples, max_samples)
