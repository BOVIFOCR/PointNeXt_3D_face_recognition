...
class CASIA_WEBFACE_3D_MICA_100subj(CASIA_WEBFACE_3D_MICA):
    
    def __init__(self,
                 num_points=2900,
                 data_dir='/datasets2/frcsyn_wacv2024/datasets/3D_reconstruction_MICA/real/1_CASIA-WebFace/output_100class',
                 split='train',
                 transform=None
                 ):
