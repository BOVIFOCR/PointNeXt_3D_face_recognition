...
class TreeBUPT_3DReconstructedMICA:
    ...
    def load_all_pairs_samples_from_protocol_file(self, dataset_path='', protocol_file_path='bupt_comparison.txt', file_ext='.npy'):
        pos_pair_label = '1'
        neg_pair_label = '0'
        src_ext = '.jpg'
        ...
        with open(protocol_file_path, 'r') as fp:
            ...
            num_folds = 10
            fold_size = int(total_num_pairs/num_folds)
            folds_indexes = [(i*fold_size, i*fold_size+fold_size) for i in range(num_folds)]
